...
export default function NavBar() {
  ...
  return (
    <div className="dark:bg-orange-950">
      <div>
        <div className="relative">
          ...
          <div
            ...
            } items-center justify-between bg-white px-6 py-5 dark:bg-orange-950 lg:hidden`}
          >
            <div className="flex items-center space-x-3 text-gray-800 dark:text-white">
              ...
              <input
                ...
                className="text-sm leading-none text-gray-600 focus:outline-none dark:bg-gray-900 dark:text-gray-300"
              />
            </div>
          ...
          {/* For md screen size */}
          {/* For large screens */}
          <div className="bg-gray-50 px-6 py-9 dark:bg-orange-950">
            <div className="container mx-auto flex items-center justify-between">
              <h1
                className="cursor-pointer text-gray-800 dark:text-white md:w-2/12"
                aria-label="Sierra Western Wear"
              >
                Sierra Western Wear
              </h1>
              <ul className="hidden w-8/12 items-center justify-center space-x-8 md:flex">
                <li>
                  <a
              ...
              <div className="flex items-center justify-end space-x-4 md:w-2/12 xl:space-x-8">
                <div className="hidden items-center lg:flex">
                  <button
                    ...
                    className="text-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-800 dark:text-white dark:hover:text-gray-300"
                  >
                    <svg
                      className="fill-stroke"
                      width={24}
                  ...
                  <input
                    ...
                    className={` ${
                      searchInput ? "hidden" : ""
                    } ml-1 rounded border border-transparent px-1 text-sm text-gray-600 focus:border-gray-400 focus:outline-none dark:bg-orange-950 dark:placeholder-gray-300`}
                  />
                </div>
                ...
                <div className="flex lg:hidden">
                  <button
                    ...
                    className="hidden rounded text-black focus:outline-none focus:ring-2 focus:ring-gray-600 dark:text-white dark:hover:text-gray-300 md:flex"
                  >
                    <svg
                      className="fill-stroke"
                      width={24}
                  ...
                  <button
                    ...
                    className="rounded text-black focus:outline-none focus:ring-2 focus:ring-gray-600 dark:text-white dark:hover:text-gray-300 md:hidden"
                  >
                    <svg
                      className="fill-stroke"
                      width={24}
          ...
          <div
            ...
            } absolute inset-0 z-10 h-screen w-full flex-col bg-white dark:bg-gray-900 md:hidden`}
          >
            <div className="flex items-center justify-between border-b border-gray-200 p-4 pb-4 dark:border-gray-700">
              <div className="flex items-center space-x-3">
                ...
                <input
                  type="text"
                  placeholder="Search for products"
                  className="text-sm text-gray-600 placeholder-gray-600 focus:outline-none dark:bg-gray-900 dark:placeholder-gray-300"
                />
              </div>
              <button
            ...
            <div className="mt-6 p-4">
              <ul className="flex flex-col space-y-6">
                <li>
                  <a
                    href="javascript:void(0)"
                    className="flex items-center justify-between text-base text-gray-800 hover:underline focus:outline-none focus:ring-2 focus:ring-gray-800 dark:text-white"
                  >
                    Home
                    <div>
                      <svg
            ...
            <div className="flex h-full items-end">
              <ul className="flex w-full flex-col space-y-8 bg-gray-50 p-4 py-10 dark:bg-gray-800">
                <li>
                  <a
                    href="javascript:void(0)"
                    className="flex items-center space-x-2 text-gray-800 hover:underline focus:outline-none focus:ring-2 focus:ring-gray-800 dark:text-white"
                  >
                    <div>
                      <svg
                        className="fill-stroke"
